      ...
      <div className="container">
        <div className="row gx-5">
          <div className="col-lg-4">
            ...
            <p>
              Discover premium game hosting servers and a curated collection of
              diverse titles at EpicRealm. With top-tier hardware and robust
              security, elevate your gaming experience today.
            </p>
          </div>
          <div className="col-lg-4">
            <div className="row">
              ...
              <div className="col-lg-6 col-sm-6">
                <div className="widget">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/affiliate">Affliates</Link>
                    </li>
                    <li>
