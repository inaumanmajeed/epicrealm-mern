      ...
      <div className="row">
        <div className="col-lg-4 col-md-6 mb-sm-30">
          ...
          <p>
            ...
            tailored to your gaming needs. Join Server Near You and elevate your
            gaming experience with unmatched speed and reliability.
          </p>
        ...
        <div className="col-lg-4 col-md-6 mb-sm-30">
          ...
          <p>
            ...
            real-time tracking, and dedicated support. Partner with us today and
            turn your gaming passion into profit.
          </p>
          <Link className="btn-line lg-w-50" to="/affiliate">
            Become an Affiliate
          </Link>
        </div>
        <div className="col-lg-4 col-md-6 mb-sm-30">
          ...
          <p>
            ...
            available 24/7 to help you with any issues or inquiries. Contact us
            anytime for prompt and reliable support. We are here to ensure your
